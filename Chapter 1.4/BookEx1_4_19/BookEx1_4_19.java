// Modify SelfAvoidingWalk.java to calculate and print the average area of the smallest axis-oriented rectangle that encloses the path.
// Keep separate statistics for escape paths and dead-end paths.

public class BookEx1_4_19 {
